...
export const profileInputSchema = z.object({
  ...
  sentinelThemesFederal: optionalStringList,
  ...
  interestProfiles: z.array(socialHandleSchema).max(2).default([]),
  interestSites: limitedOptionalStringList(2),
  oppositionProfiles: z.array(socialHandleSchema).max(2).default([]),
