...
export const ROADMAP_SEED: SeedRow[] = [
  ...
  },
  {
    ...
    status: "inprogress",
    validatedByThiago: "pendente",
    observation: "PDFs + e-mail ok; NF no aceite ainda não (e-mail NF pós-autorização Asaas)",
  },
  {
    section: "pos-25",
    ...
    status: "todo",
    validatedByThiago: "pendente",
    observation: "Só copy na UI; cobrança continua em Planos → checkout",
  },
  {
    section: "pos-25",
    ...
    status: "done",
    validatedByThiago: "pendente",
    observation: "UI lock + overlay quando past_due/pending_payment; libera Meus pagamentos/CNPJ",
  },
  {
    section: "pos-25",
    ...
    status: "done",
    validatedByThiago: "pendente",
    observation: "Item no Acesso antecipado + banner D-5",
  },
  {
    section: "pos-25",
    ...
    status: "done",
    validatedByThiago: "pendente",
    observation: "Cadeados no nav + overlay; alerta por data de vencimento",
  },
  {
    section: "pos-25",
    ...
    status: "todo",
    validatedByThiago: "pendente",
    observation: "Não documentado; nim.video ausente",
  },
  {
    section: "pos-25",
