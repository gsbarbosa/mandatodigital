    ...
    <div className="min-h-full relative overflow-hidden pb-24">
      ...
      <div className="max-w-5xl mx-auto relative z-10 px-4 sm:px-6 lg:px-8 pt-[51px] md:pt-[77px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center mb-16">
          {/* Avatar */}
          <div className="bg-md-surface/30 backdrop-blur-xl border border-md-border rounded-[1.75rem] p-8 flex flex-col items-center justify-center shadow-xl relative transition-all duration-300 hover:border-cyan-500/40 hover:shadow-[0_0_40px_rgba(6,182,212,0.15)] group">
            <div className="relative w-full max-w-[280px] aspect-square rounded-2xl overflow-hidden border-2 border-md-border group-hover:border-cyan-400/60 transition-colors shadow-2xl bg-gradient-to-b from-md-surface to-md-bg flex items-center justify-center">
              {previewSrc && !previewFailed ? (
                ...
                <div className="text-center px-6">
                  <p className="text-md-text-soft text-sm">
                    {previewFailed
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-md-bg via-transparent to-transparent opacity-60 pointer-events-none" />
            </div>
            ...
            {isDerivedFromGemeo ? (
              <div className="w-full max-w-[280px] mt-4 flex flex-col items-center gap-2">
                ...
                >
                  <svg
                    className={`h-4 w-4 shrink-0 text-[var(--curador-text)] ${isRegenerating ? "animate-spin" : ""}`}
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    strokeWidth="2"
                ...
                {regenerateSuccess ? (
                  <p className="text-center text-xs text-[var(--sentinela-text)] leading-relaxed" role="status">
                    {regenerateSuccess}
                  </p>
                ) : null}
                {isRegenerating ? (
                  <p className="text-center text-xs text-[var(--curador-text)] leading-relaxed" role="status">
              ...
              <button
                ...
                className="w-full max-w-[280px] mt-4 group/edit inline-flex items-center justify-center gap-2 rounded-xl border border-md-border/70 bg-md-bg/50 px-4 py-2.5 text-sm font-medium text-md-text shadow-sm transition-all hover:border-cyan-500/45 hover:bg-[var(--curador-soft)] hover:text-md-text focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500/40"
              >
                <svg
                  className="h-4 w-4 shrink-0 text-[var(--curador-text)] transition-colors group-hover/edit:text-[var(--curador-text)]"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth="2"
          ...
          <div className="lg:col-span-2 flex flex-col gap-5">
            <Link
              ...
              className="no-underline w-full text-left bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-md-text font-bold py-5 px-6 rounded-2xl btn-transition shadow-[0_4px_20px_rgba(6,182,212,0.25)] hover:shadow-[0_6px_25px_rgba(6,182,212,0.35)] focus:outline-none focus:ring-2 focus:ring-cyan-400 flex items-center justify-between group"
            >
            ...
            <Link
              ...
              className="no-underline w-full text-left bg-md-surface/40 hover:bg-md-overlay-hover text-md-text-muted hover:text-md-text font-medium py-5 px-6 rounded-2xl btn-transition border border-md-border hover:border-md-border shadow-md focus:outline-none focus:ring-2 focus:ring-slate-500 flex items-center justify-between group"
            >
              <span className="text-base sm:text-lg">Criar conteúdo independente</span>
              <ArrowIcon className="h-6 w-6 text-md-text-soft group-hover:text-md-text-muted transform group-hover:translate-x-1 transition-transform" />
            </Link>

            <div className="h-px w-full bg-md-surface-inset my-2" />

            <Link
              href={"/curador" as Route}
              className="no-underline w-full text-left bg-md-surface/50 hover:bg-md-overlay-hover text-md-text font-medium py-5 px-6 rounded-2xl btn-transition border border-md-border hover:border-slate-500 shadow-md focus:outline-none focus:ring-2 focus:ring-slate-500 flex items-center justify-between group"
            >
              <span className="text-sm sm:text-base">
                Personalizar - posição ideológica e glossário pessoal
              </span>
              <svg className="h-5 w-5 text-md-text-soft group-hover:text-md-text transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        ...
        {/* Aviso */}
        <div className="bg-gradient-to-br from-md-slate-900 to-md-bg border border-amber-500/40 rounded-2xl p-6 md:p-8 relative overflow-hidden shadow-2xl">
      ...
      {!isDerivedFromGemeo && confirmRetrain ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          />
          <div className="relative bg-md-surface border border-md-border rounded-2xl p-8 max-w-md w-full shadow-2xl">
            <h3 className="text-lg font-bold text-md-text mb-3">Treinar novamente seu Avatar?</h3>
