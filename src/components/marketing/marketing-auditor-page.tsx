              ...
              <tbody>
                {report.rows.map((row) => {
                  ...
                  return (
                    <tr
                      key={row.post}
                      className={`border-b border-md-border-soft last:border-b-0 ${
                        rejected ? "bg-rose-500/5" : ""
                      }`}
                    >
                      <td
                        className={`px-4 py-3.5 text-md-text first:pl-5 ${
                      ...
                      <td className="px-4 py-3.5 text-md-text-muted">{row.validator}</td>
                      <td className="px-4 py-3.5">
                        <span
                      ...
                      <td className="px-4 py-3.5 last:pr-5">
                        <span className="inline-flex items-center gap-2 text-md-text-soft">
                          <IconLink size={14} />
                          {row.print}
                        </span>
                      </td>
