    ...
    <>
      ...
      <AgentDetailSection title={liveConsole.title} lead={liveConsole.subtitle} accent="sentinela">
        ...
        >
          ...
          <div className="flex flex-col items-start gap-3 border-t border-md-border bg-md-bg/40 px-4 py-4 sm:flex-row sm:items-center sm:justify-start sm:gap-4 sm:px-5">
