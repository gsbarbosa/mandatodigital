...
- **Marketing outbound `/admin/marketing`** — base de prospects públicos, segmentação, campanhas de e-mail e WhatsApp, com IA conduzindo a conversa após a resposta do lead — ver [docs/marketing-outbound.md](docs/marketing-outbound.md).
...
- [ADR — Marketing outbound dentro do mandatodigital](docs/adr-marketing-outbound-no-monolito.md)
